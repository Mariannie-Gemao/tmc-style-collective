...
const sourcingCategories = [
  { name: "Hardware", slug: "hardware", icon: Wrench, description: "Bolts, nuts, hinges, locks, fasteners, and all types of hardware supplies sourced from trusted global manufacturers." },
  { name: "Electronics", slug: "electronics", icon: Cpu, description: "Consumer electronics, components, circuit boards, sensors, and smart devices from certified factories." },
  { name: "Construction Materials", slug: "construction-materials", icon: HardHat, description: "Cement, steel bars, roofing, tiles, pipes, and bulk construction materials at competitive wholesale prices." },
  { name: "Furniture", slug: "furniture", icon: Sofa, description: "Office furniture, home furniture, custom designs, and bulk orders from leading furniture manufacturers." },
