      ...
      <div className="relative lg:flex-1 p-8 lg:p-16 hidden lg:flex flex-col justify-center z-10">
        <div className="relative z-10 max-w-lg mx-auto lg:mx-0">
          ...
          <div className="hidden lg:grid grid-cols-3 gap-4 mt-12">
            {[
              { img: "https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=200&h=200&fit=crop", label: "Watches", delay: "0s" },
              { img: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=200&h=200&fit=crop", label: "Audio", delay: "1s" },
              { img: "https://images.unsplash.com/photo-1572635196237-14b3f281503f?w=200&h=200&fit=crop", label: "Eyewear", delay: "2s" },
            ].map((item, i) => (
              <div
                key={i}
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <Input type={showPassword ? "text" : "password"} placeholder="Enter your password" value={password} onChange={(e) => setPassword(e.target.value)} className="h-12 rounded-xl pl-10 pr-10 border border-white/20 bg-white/10 backdrop-blur-sm text-white placeholder:text-white/30 focus:border-accent focus:ring-accent/30 transition-all" required />
              ...
              <Button type="submit" disabled={loading} className="w-full h-12 rounded-xl bg-accent hover:bg-accent-dark text-accent-foreground font-bold text-base shadow-lg shadow-accent/30 btn-shine transition-all duration-300 hover:shadow-accent/50 hover:scale-[1.02]">
